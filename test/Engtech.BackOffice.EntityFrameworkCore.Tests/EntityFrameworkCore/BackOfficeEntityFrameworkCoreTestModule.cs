...
public class BackOfficeEntityFrameworkCoreTestModule : AbpModule
{
    ...
    private void ConfigureInMemorySqlite(IServiceCollection services)
    {
        ...
        _database.CreateTables(
            new BackOfficeDbContext(new DbContextOptionsBuilder<BackOfficeDbContext>().UseSqlite(_database.ConnectionString).Options));
