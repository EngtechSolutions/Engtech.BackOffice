...
[Authorize(BackOfficePermissions.Books.Default)]
public class BookAppService : ApplicationService, IBookAppService
{
    ...
    [Authorize(BackOfficePermissions.Books.Create)]
    ...
    [Authorize(BackOfficePermissions.Books.Edit)]
    ...
    [Authorize(BackOfficePermissions.Books.Delete)]
